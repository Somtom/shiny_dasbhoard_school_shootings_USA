...
to more deaths at schools than members of the US military have been killed while beeing deployed
this year.   

We hear about those shootings quite often in the news, and after almost every of theses 
a new discussion about the USA gun laws arrises. 
...
decided to create a interactive dashboard to expolre the data a little bit further.
...
Dasbhoard](https://somtom.shinyapps.io/usa_school_shootings_shiny/)
...
For those who are interessted in the data cleaning and preparation, I will go trough this
process step by step in the rest of the blogpost.
...
We need to performe some data processing and cleaning steps so that we can use it for our dashbaord.
This steps include:  
...
interactive map. I also used this package within the Shiny dasbhoard. Here we will show all
